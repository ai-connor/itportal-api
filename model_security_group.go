...
type SecurityGroup struct {
	...
	// The JSON array designating the User.
...
func (o *SecurityGroup) GetUsers() []User {
...
// and a boolean to check if the value has been set.
func (o *SecurityGroup) GetUsersOk() ([]User, bool) {
	if o == nil || IsNil(o.Users) {
		return nil, false
	}
	return o.Users, true
...
func (o *SecurityGroup) HasUsers() bool {
	if o != nil && !IsNil(o.Users) {
		return true
	}
...
func (o *SecurityGroup) SetUsers(v []User) {
	o.Users = v
}
