...
type ConfigurationType struct {
	// The unique type ID of the configuration.
...
func (o *ConfigurationType) GetId() int64 {
	if o == nil || IsNil(o.Id) {
		var ret int64
		return ret
	}
...
func (o *ConfigurationType) GetIdOk() (*int64, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *ConfigurationType) SetId(v int64) {
	o.Id = &v
}
...
func (o *ConfigurationType) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
