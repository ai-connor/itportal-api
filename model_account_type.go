...
func (o *AccountType) GetId() int64 {
	if o == nil || IsNil(o.Id) {
		var ret int64
		return ret
	}
...
func (o *AccountType) GetIdOk() (*int64, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *AccountType) SetId(v int64) {
	o.Id = &v
}
...
func (o *AccountType) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
